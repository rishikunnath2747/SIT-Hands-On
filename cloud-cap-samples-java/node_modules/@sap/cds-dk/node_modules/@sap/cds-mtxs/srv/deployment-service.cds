...
extend service cds.xt.DeploymentService with {
    @requires: ['cds.Developer', 'internal-user']
    function tenantsByDb(tenants: Array of String, metadata: Boolean) returns {};

    @requires: ['cds.Developer', 'internal-user']
    function getTablesDeep(@mandatory tenant: String) returns Array of {};
