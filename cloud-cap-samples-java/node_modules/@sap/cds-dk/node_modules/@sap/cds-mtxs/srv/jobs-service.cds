...
service cds.xt.JobsService {
  ...
  @open @requires: ['internal-user', 'cds.Subscriber', 'mtcallback']
  action enqueue(
    service: String,
    op: String,
    @cds.validate: false clusters: array of Set,
    @cds.validate: false args: array of {},
    callback: {}
  ) returns Jobs;
  ...
  @private @requires: ['internal-user', 'cds.Developer'] 
  function config() returns {};
}
